...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='PFRP')
    ...
    # Autoformer, FEDformer, Informer, NSTransformer, PatchTST, TimeXer, TFT, TiDE, TimesNet, TimeMixer
    parser.add_argument('--dropout', type=float, default=0.1, help='dropout')
    parser.add_argument('--embed', type=str, default='timeF', help='time features encoding: [timeF, fixed, learned]')
    # Autoformer, FEDformer, Informer, NSTransformer, PatchTST, TimeXer
    ...
    parser.add_argument('--decomp_method', type=str, default='moving_avg', help='method of series decompsition: [moving_avg, dft_decomp]')
    parser.add_argument('--down_sampling_layers', type=int, default=0, help='num of down sampling layers')
    parser.add_argument('--down_sampling_window', type=int, default=1, help='down sampling window size')
    parser.add_argument('--down_sampling_method', type=str, default=None, help='down sampling method: [avg, max, conv]')
    # TimeXer
    ...
    # PFRP
    parser.add_argument('--d_ff_PFRP', type=int, default=128)
    parser.add_argument('--topk_PFRP', type=int, default=10)
